...
namespace MyVaccineWebApi.Services.Implements
{
    ...
    {
        private readonly IVaccineRecordRepository _repositoryvaccine;
        private readonly MyVaccineAppDbContext _context;

        public VaccineRecordService(IVaccineRecordRepository repositoryvaccine, MyVaccineAppDbContext context)
        {
